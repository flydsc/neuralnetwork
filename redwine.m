...
[f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,class] = textread(file , '%f%f%f%f%f%f%f%f%f%f%f%f','delimiter',',');
[t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,c] = textread('test-red.csv' , '%f%f%f%f%f%f%f%f%f%f%f%f','delimiter',',');
